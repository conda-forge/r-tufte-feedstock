...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-tufte-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-tufte-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-tufte-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-tufte-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-tufte-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-tufte-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-tufte` can be installed with:

```
conda install r-tufte
```

It is possible to list all of the versions of `r-tufte` available on your platform with:
